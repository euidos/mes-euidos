...
export const useGetStatementDetails = (id: string) => {
    return useFrappeGetCall<{ message: GetStatementDetailsResponse }>("mes_euidos.accounts.doctype.bank_statement_import_log.bank_statement_import_log.get_statement_details", {
...
export const useUpdatePDFTables = () => {
    return useFrappePostCall<{ message: GetStatementDetailsResponse }>("mes_euidos.accounts.doctype.bank_statement_import_log.bank_statement_import_log.update_pdf_tables")
}

export const useReextractPDFTable = () => {
    return useFrappePostCall<{ message: GetStatementDetailsResponse }>("mes_euidos.accounts.doctype.bank_statement_import_log.bank_statement_import_log.reextract_pdf_table")
}

export const useSetPDFTableHeader = () => {
    return useFrappePostCall<{ message: GetStatementDetailsResponse }>("mes_euidos.accounts.doctype.bank_statement_import_log.bank_statement_import_log.set_pdf_table_header")
}

export const useUpdateColumnMapping = () => {
    return useFrappePostCall<{ message: GetStatementDetailsResponse }>("mes_euidos.accounts.doctype.bank_statement_import_log.bank_statement_import_log.update_column_mapping")
}

export const useSetHeaderIndex = () => {
    return useFrappePostCall<{ message: GetStatementDetailsResponse }>("mes_euidos.accounts.doctype.bank_statement_import_log.bank_statement_import_log.set_header_index")
}
...
export interface AccountsSettings {
	...
	/**	Enable Common Party Accounting : Check - Learn about <a href="https://docs.frappe.io/mes_euidos/user/manual/en/common_party_accounting" rel="noopener noreferrer">Common Party</a>	*/

...
mes_euidos.accounts.taxes.setup_tax_validations("Sales Taxes and Charges Template");
mes_euidos.accounts.taxes.setup_tax_filters("Sales Taxes and Charges");
mes_euidos.pre_sales.set_as_lost("Quotation");
...
mes_euidos.selling.QuotationController = class QuotationController extends mes_euidos.selling.SellingController {
	onload(doc, dt, dn) {
	...
	set_dynamic_field_label() {
		if (this.frm.doc.quotation_to == "Customer") {
			...
			this.frm.fields_dict.party_name.get_query = function () {
				return { query: "mes_euidos.controllers.queries.lead_query" };
			};
	...
	get_lead_details() {
		...
		frappe.call({
			method: "mes_euidos.crm.doctype.lead.lead.get_lead_details",
			args: {
...
cur_frm.script_manager.make(mes_euidos.selling.QuotationController);

...
from mes_euidos.selling.doctype.quotation.quotation import make_sales_order
...
class TestQuotation(ERPNextTestSuite):
	...
	def test_gross_profit(self):
		...
		from mes_euidos.stock.get_item_details import ItemDetailsCtx, insert_item_price
	...
	def test_quotation_expiry(self):
		from mes_euidos.selling.doctype.quotation.quotation import set_expired_status

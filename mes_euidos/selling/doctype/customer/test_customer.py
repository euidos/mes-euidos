...
from mes_euidos.accounts.party import get_due_date
from mes_euidos.exceptions import PartyDisabled, PartyFrozen
from mes_euidos.selling.doctype.customer.customer import (
	get_credit_limit,
...
class TestCustomer(ERPNextTestSuite):
	...
	def test_customer_credit_limit_after_submit(self):
		from mes_euidos.controllers.accounts_controller import update_child_qty_rate
		from mes_euidos.selling.doctype.sales_order.test_sales_order import make_sales_order

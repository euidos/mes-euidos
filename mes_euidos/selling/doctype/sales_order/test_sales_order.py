...
from mes_euidos.controllers.accounts_controller import InvalidQtyError, get_due_date, update_child_qty_rate
from mes_euidos.maintenance.doctype.maintenance_schedule.test_maintenance_schedule import (
	make_maintenance_schedule,
)
from mes_euidos.maintenance.doctype.maintenance_visit.test_maintenance_visit import (
...
from mes_euidos.stock.get_item_details import get_bin_details
...
class TestSalesOrder(ERPNextTestSuite):
	...
	def test_drop_shipping(self):
		from mes_euidos.buying.doctype.purchase_order.purchase_order import update_status
		from mes_euidos.selling.doctype.sales_order.sales_order import update_status as so_update_status
	...
	def test_make_work_order(self):
		from mes_euidos.selling.doctype.sales_order.sales_order import get_work_order_items
	...
	def test_so_back_updated_from_wo_via_mr(self):
		...
		from mes_euidos.stock.doctype.material_request.material_request import raise_work_orders
	...
	@patch(
		...
		"mes_euidos.accounts.doctype.payment_request.payment_request.PaymentRequest.get_payment_url",
		return_value=None,
	)
	...
	def test_pick_list_for_batch(self):
		from mes_euidos.stock.doctype.pick_list.pick_list import create_delivery_note

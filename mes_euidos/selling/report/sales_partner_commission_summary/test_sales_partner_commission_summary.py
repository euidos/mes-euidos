...
from mes_euidos.selling.report.sales_partner_commission_summary.sales_partner_commission_summary import (
...
class SalesPartnerSummaryReportTestMixin(ERPNextTestSuite):
	...
	def create_transactions(self, doctype):
		from mes_euidos.accounts.doctype.pos_invoice.test_pos_invoice import (
			POSInvoiceTestMixin,
			create_pos_invoice,
		)

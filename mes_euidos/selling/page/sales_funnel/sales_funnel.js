...
frappe.pages["sales-funnel"].on_page_load = function (wrapper) {
	...
	wrapper.sales_funnel = new mes_euidos.SalesFunnel(wrapper);

	frappe.breadcrumbs.add("Selling");
};

mes_euidos.SalesFunnel = class SalesFunnel {
	constructor(wrapper) {
		var me = this;
	...
	get_data(btn) {
		...
		const method_map = {
			sales_funnel: "mes_euidos.selling.page.sales_funnel.sales_funnel.get_funnel_data",
			opp_by_utm_source: "mes_euidos.selling.page.sales_funnel.sales_funnel.get_opp_by_utm_source",
			opp_by_utm_campaign: "mes_euidos.selling.page.sales_funnel.sales_funnel.get_opp_by_utm_campaign",
			opp_by_utm_medium: "mes_euidos.selling.page.sales_funnel.sales_funnel.get_opp_by_utm_medium",
			sales_pipeline: "mes_euidos.selling.page.sales_funnel.sales_funnel.get_pipeline_data",
		};
		frappe.call({

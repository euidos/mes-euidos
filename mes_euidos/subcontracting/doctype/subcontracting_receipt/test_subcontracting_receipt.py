...
class TestSubcontractingReceipt(ERPNextTestSuite):
	...
	def test_subcontracting_over_receipt(self):
		...
		"""
		from mes_euidos.controllers.subcontracting_controller import (
	...
	def test_subcontracting_receipt_gl_entry(self):
		...
		self.assertEqual(cint(mes_euidos.is_perpetual_inventory_enabled(scr.company)), 1)
	...
	def test_inventory_dimensions(self):
		...
		"""
		from mes_euidos.stock.doctype.inventory_dimension.test_inventory_dimension import (

...
from mes_euidos.buying.doctype.purchase_order.purchase_order import get_mapped_subcontracting_order
...
class TestSubcontractingOrder(ERPNextTestSuite):
	...
	def test_stock_reservation_transfer(self):
		...
		from mes_euidos.manufacturing.doctype.production_plan.test_production_plan import create_production_plan
		from mes_euidos.stock.doctype.stock_reservation_entry.stock_reservation_entry import (

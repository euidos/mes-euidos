...
class SubcontractingInwardOrder(SubcontractingController):
	...
	if TYPE_CHECKING:
		...
		from mes_euidos.subcontracting.doctype.subcontracting_inward_order_item.subcontracting_inward_order_item import (
			SubcontractingInwardOrderItem,
		)
		from mes_euidos.subcontracting.doctype.subcontracting_inward_order_received_item.subcontracting_inward_order_received_item import (
			SubcontractingInwardOrderReceivedItem,
		)
		from mes_euidos.subcontracting.doctype.subcontracting_inward_order_secondary_item.subcontracting_inward_order_secondary_item import (
			SubcontractingInwardOrderSecondaryItem,
		)
		from mes_euidos.subcontracting.doctype.subcontracting_inward_order_service_item.subcontracting_inward_order_service_item import (

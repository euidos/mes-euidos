...
from mes_euidos.manufacturing.doctype.work_order.work_order import make_stock_entry as make_stock_entry_from_wo
from mes_euidos.selling.doctype.sales_order.sales_order import make_subcontracting_inward_order
...
class IntegrationTestSubcontractingInwardOrder(ERPNextTestSuite):
	...
	def test_subcontracting_delivery(self):
		from mes_euidos.stock.serial_batch_bundle import get_serial_batch_list_from_item
...
def make_service_items():
	from mes_euidos.controllers.tests.test_subcontracting_controller import make_service_item

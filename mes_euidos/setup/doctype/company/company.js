...
frappe.provide("mes_euidos.company");
...
frappe.ui.form.on("Company", {
	...
	delete_company_transactions: function (frm) {
		frappe.call({
			method: "mes_euidos.setup.doctype.transaction_deletion_record.transaction_deletion_record.is_deletion_doc_running",
			args: {
				company: frm.doc.name,
			},
			freeze: true,
					...
					frappe.verify_password(function () {
						var d = frappe.prompt(
							...
							function (data) {
								...
								frappe.call({
									method: "mes_euidos.setup.doctype.company.company.create_transaction_deletion_request",
									args: {

...
mes_euidos.setup.EmployeeController = class EmployeeController extends frappe.ui.form.Controller {
	setup() {
			...
			frm.add_custom_button(__("Create User"), () => {
				const dialog = new frappe.ui.Dialog({
					...
					primary_action: (values) => {
						...
						frappe
							.call({
								method: "mes_euidos.setup.doctype.employee.employee.create_user",
								args: {
...
cur_frm.cscript = new mes_euidos.setup.EmployeeController({
	frm: cur_frm,
});

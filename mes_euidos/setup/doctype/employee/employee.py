...
from mes_euidos.utilities.transaction_base import delete_events
...
class Employee(NestedSet):
	...
	if TYPE_CHECKING:
		...
		from mes_euidos.setup.doctype.employee_education.employee_education import EmployeeEducation
		from mes_euidos.setup.doctype.employee_external_work_history.employee_external_work_history import (
			EmployeeExternalWorkHistory,
		)
		from mes_euidos.setup.doctype.employee_internal_work_history.employee_internal_work_history import (

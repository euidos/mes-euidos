...
class TransactionDeletionRecord(Document):
	...
	if TYPE_CHECKING:
		...
		from mes_euidos.accounts.doctype.transaction_deletion_record_details.transaction_deletion_record_details import (
			TransactionDeletionRecordDetails,
		)
		from mes_euidos.setup.doctype.transaction_deletion_record_item.transaction_deletion_record_item import (
			TransactionDeletionRecordItem,
		)
		from mes_euidos.setup.doctype.transaction_deletion_record_to_delete.transaction_deletion_record_to_delete import (

...
from mes_euidos.setup.doctype.incoterm.incoterm import create_incoterms
from mes_euidos.setup.utils import identity as _

from .default_success_action import get_default_success_action

default_mail_footer = """<div style="padding: 7px; text-align: right; color: #888"><small>Sent via
	<a style="color: #888" href="http://frappe.io/mes_euidos">ERPNext</a></div>"""
...
def create_letter_head():
	base_path = frappe.get_app_path("mes_euidos", "accounts", "letterhead")
...
def toggle_hidden_fields():
	from mes_euidos.accounts.doctype.accounts_settings.accounts_settings import (
...
def after_app_install(app_name=None):
	if app_name == "crm":
		from mes_euidos.crm.frappe_crm_api import remove_allowed_users_on_crm_install
...
def after_app_uninstall(app_name=None):
	if app_name == "crm":
		from mes_euidos.crm.frappe_crm_api import disable_frappe_crm_data_synchronization_on_crm_uninstall

...
def setup_demo_data(company_name):
	...
	try:
		...
		capture("demo_data_creation_failed", "mes_euidos", properties={"exception": frappe.get_traceback()})
...
def clear_demo_data():
	...
	capture("demo_data_erased", "mes_euidos")
	try:
...
def make_transactions(company):
	...
	from mes_euidos.accounts.utils import FiscalYearError

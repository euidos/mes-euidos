...
import mes_euidos
from mes_euidos.accounts.utils import get_currency_precision, get_stock_accounts
from mes_euidos.stock.doctype.stock_reposting_settings.stock_reposting_settings import get_stock_ledgers
from mes_euidos.stock.doctype.warehouse.warehouse import get_warehouses_based_on_account


def execute(filters=None):
	if not mes_euidos.is_perpetual_inventory_enabled(filters.company):
		frappe.throw(

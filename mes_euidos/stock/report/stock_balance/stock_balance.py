...
from mes_euidos.stock.doctype.stock_closing_entry.stock_closing_entry import StockClosing
from mes_euidos.stock.doctype.warehouse.warehouse import apply_warehouse_filter
from mes_euidos.stock.report.stock_ageing.stock_ageing import (
	FIFOSlots,
	get_average_age,
	normalize_fifo_queue,
)
from mes_euidos.stock.utils import add_additional_uom_columns
...
class StockBalanceReport:
	...
	def set_company_currency(self) -> None:
		if self.filters.get("company"):
			self.company_currency = mes_euidos.get_company_currency(self.filters.get("company"))
		else:

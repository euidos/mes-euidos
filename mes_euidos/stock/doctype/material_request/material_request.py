...
from mes_euidos.buying.utils import check_on_hold_or_closed_status, validate_for_items
...
from mes_euidos.stock.get_item_details import get_price_list_rate_for
from mes_euidos.stock.stock_balance import get_indented_qty, update_bin_qty
...
class MaterialRequest(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from mes_euidos.stock.doctype.material_request_item.material_request_item import MaterialRequestItem
	...
	def validate(self):
		...
		from mes_euidos.controllers.status_updater import validate_status

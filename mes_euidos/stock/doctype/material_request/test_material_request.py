...
from mes_euidos.stock.doctype.stock_entry.stock_entry import make_stock_in_entry
...
class TestMaterialRequest(ERPNextTestSuite):
	...
	def test_partial_make_stock_entry(self):
		from mes_euidos.stock.doctype.stock_entry.stock_entry_utils import make_stock_entry as _make_stock_entry
	...
	def test_auto_email_users_with_company_user_permissions(self):
		from mes_euidos.stock.reorder_item import get_email_list
	...
	def test_get_remaining_qty_from_sales_order(self):
		...
		from mes_euidos.selling.doctype.sales_order.sales_order import make_material_request
		from mes_euidos.selling.doctype.sales_order.test_sales_order import make_sales_order

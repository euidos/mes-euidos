...
from mes_euidos.selling.doctype.sales_order.sales_order import create_pick_list
...
from mes_euidos.stock.doctype.packed_item.test_packed_item import create_product_bundle
from mes_euidos.stock.doctype.pick_list.pick_list import (
	create_delivery,
...
class TestPickList(ERPNextTestSuite):
	...
	def test_pick_list_warehouse_for_work_order(self):
		...
		from mes_euidos.manufacturing.doctype.work_order.work_order import create_pick_list, make_work_order
		from mes_euidos.stock.doctype.warehouse.test_warehouse import create_warehouse
	...
	def test_multiple_pick_lists_delivery_note(self):
		from mes_euidos.stock.doctype.pick_list.pick_list import create_dn_for_pick_lists
	...
	def test_creating_dn_from_so_with_different_addresses(self):
		...
		map_docs(
			"mes_euidos.selling.doctype.sales_order.sales_order.create_pick_list",

...
def _repost_stock_ledger_variance(company, fy_start_date):
	from mes_euidos.stock.report.stock_ledger_variance.stock_ledger_variance import (
...
def _repost_stock_account_value_comparison(company, fy_start_date):
	...
	if not mes_euidos.is_perpetual_inventory_enabled(company):
		return

	from mes_euidos.stock.report.stock_and_account_value_comparison.stock_and_account_value_comparison import (

...
mes_euidos.landed_cost_taxes_and_charges.setup_triggers("Landed Cost Voucher");
mes_euidos.stock.LandedCostVoucher = class LandedCostVoucher extends mes_euidos.stock.StockController {
	refresh() {
...
cur_frm.script_manager.make(mes_euidos.stock.LandedCostVoucher);
...
frappe.ui.form.on("Landed Cost Voucher", {
	...
	setup_queries(frm) {
		...
		frm.set_query("vendor_invoice", "vendor_invoices", (doc, cdt, cdn) => {
			return {
				query: "mes_euidos.stock.doctype.landed_cost_voucher.landed_cost_voucher.get_vendor_invoices",
				filters: {
					company: doc.company,
				},
			};

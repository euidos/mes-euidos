...
class TestBatch(ERPNextTestSuite):
	...
	def test_batch_qty_on_pos_creation(self):
		from mes_euidos.accounts.doctype.pos_closing_entry.test_pos_closing_entry import (
			init_user_and_profile,
		)
		from mes_euidos.accounts.doctype.pos_invoice.test_pos_invoice import create_pos_invoice
	...
	def test_batch_split(self):
		...
		from mes_euidos.stock.doctype.batch.batch import split_batch

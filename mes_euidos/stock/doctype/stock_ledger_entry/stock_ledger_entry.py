...
from mes_euidos.controllers.item_variant import ItemTemplateCannotHaveStock
from mes_euidos.stock.doctype.inventory_dimension.inventory_dimension import get_inventory_dimensions
from mes_euidos.stock.serial_batch_bundle import SerialBatchBundle
...
class StockLedgerEntry(Document):
	...
	def validate_and_set_fiscal_year(self):
		if not self.fiscal_year:
			...
			from mes_euidos.accounts.utils import validate_fiscal_year
	...
	def block_transactions_against_group_warehouse(self):
		from mes_euidos.stock.utils import is_group_warehouse

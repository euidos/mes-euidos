...
from mes_euidos.accounts.doctype.gl_entry.gl_entry import rename_gle_sle_docs
...
from mes_euidos.stock.doctype.stock_ledger_entry.stock_ledger_entry import BackDatedStockTransaction
...
class TestStockLedgerEntry(ERPNextTestSuite, StockTestMixin):
	...
	def test_tie_breaking(self):
		from mes_euidos.stock.doctype.repost_item_valuation.repost_item_valuation import repost_entries
	...
	def test_update_qty_in_future_sle_shifts_same_timestamp_later_entry(self):
		...
		from mes_euidos.stock.stock_ledger import update_qty_in_future_sle
	...
	def test_get_next_stock_reco_respects_creation_order(self):
		...
		from mes_euidos.stock.stock_ledger import get_next_stock_reco

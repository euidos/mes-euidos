...
from mes_euidos.accounts.party import CROSS_PARTY_FIELD_NO_MAP, get_due_date
from mes_euidos.controllers.accounts_controller import get_taxes_and_charges, merge_taxes
...
class DeliveryNote(SellingController):
	...
	if TYPE_CHECKING:
		...
		from mes_euidos.stock.doctype.delivery_note_item.delivery_note_item import DeliveryNoteItem

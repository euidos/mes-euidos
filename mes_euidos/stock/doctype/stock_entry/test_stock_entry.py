...
from mes_euidos.stock.doctype.item.test_item import (
	create_item,
	make_item,
	make_item_variant,
	set_item_variant_settings,
)
from mes_euidos.stock.doctype.material_request.material_request import (
	make_in_transit_stock_entry,
)
from mes_euidos.stock.doctype.material_request.test_material_request import (
...
from mes_euidos.stock.doctype.serial_no.serial_no import *
from mes_euidos.stock.doctype.stock_entry.stock_entry import FinishedGoodError, make_stock_in_entry
from mes_euidos.stock.doctype.stock_entry.stock_entry_utils import make_stock_entry
from mes_euidos.stock.doctype.stock_ledger_entry.stock_ledger_entry import StockFreezeError
from mes_euidos.stock.doctype.stock_reconciliation.stock_reconciliation import (
	OpeningEntryAccountError,
)
from mes_euidos.stock.doctype.stock_reconciliation.test_stock_reconciliation import (
	create_stock_reconciliation,
)
from mes_euidos.stock.serial_batch_bundle import SerialBatchCreation
from mes_euidos.stock.stock_ledger import NegativeStockError, get_previous_sle
...
class TestStockEntry(ERPNextTestSuite):
	...
	def _test_auto_material_request(
		...
		from mes_euidos.stock.reorder_item import reorder_item
	...
	def test_serial_batch_item_stock_entry(self):
		...
		"""
		from mes_euidos.stock.doctype.batch.batch import get_batch_qty
	...
	def test_warehouse_company_validation(self):
		...
		with self.set_user("test2@example.com"):
			from mes_euidos.stock.utils import InvalidWarehouseCompany
	...
	def test_work_order(self):
		from mes_euidos.manufacturing.doctype.work_order.work_order import (
	...
	def test_variant_work_order(self):
		...
		from mes_euidos.manufacturing.doctype.work_order.work_order import make_stock_entry
	...
	def test_check_item_quality_inspection_returns_items_for_stock_entry(self):
		from mes_euidos.controllers.stock_controller import check_item_quality_inspection
	...
	def test_quality_inspection_across_stock_entry_purposes(self):
		from mes_euidos.controllers.stock_controller import check_item_quality_inspection
		from mes_euidos.exceptions import QualityInspectionRejectedError, QualityInspectionRequiredError
		from mes_euidos.stock.doctype.quality_inspection.test_quality_inspection import (
	...
	def test_quality_inspection_required_for_manufacture(self):
		from mes_euidos.exceptions import QualityInspectionRejectedError, QualityInspectionRequiredError
		from mes_euidos.manufacturing.doctype.work_order.test_work_order import make_wo_order_test_record
		from mes_euidos.manufacturing.doctype.work_order.work_order import (
	...
	def test_quality_inspection_required_for_send_to_subcontractor(self):
		from mes_euidos.controllers.subcontracting_controller import make_rm_stock_entry
		from mes_euidos.controllers.tests.test_subcontracting_controller import (
			get_subcontracting_order,
			make_service_item,
		)
		from mes_euidos.exceptions import QualityInspectionRequiredError
		from mes_euidos.stock.doctype.quality_inspection.test_quality_inspection import (
			create_quality_inspection,
		)
	...
	def test_quality_inspection_required_for_disassemble(self):
		from mes_euidos.exceptions import QualityInspectionRejectedError, QualityInspectionRequiredError
		from mes_euidos.manufacturing.doctype.production_plan.test_production_plan import make_bom
		from mes_euidos.manufacturing.doctype.work_order.test_work_order import make_wo_order_test_record
		from mes_euidos.manufacturing.doctype.work_order.work_order import (
			make_stock_entry as make_wo_stock_entry,
		)
	...
	def test_future_negative_sle_batch(self):
		from mes_euidos.stock.doctype.batch.test_batch import TestBatch
	...
	def test_mapped_stock_entry(self):
		...
		from mes_euidos.stock.doctype.purchase_receipt.purchase_receipt import make_stock_entry
	...
	def test_reposting_for_depedent_warehouse(self):
		from mes_euidos.stock.doctype.repost_item_valuation.repost_item_valuation import repost_sl_entries
		from mes_euidos.stock.doctype.warehouse.test_warehouse import create_warehouse
	...
	def test_batch_expiry(self):
		from mes_euidos.controllers.stock_controller import BatchExpiredError
		from mes_euidos.stock.doctype.batch.test_batch import make_new_batch
	...
	def test_sample_retention_stock_entry(self):
		from mes_euidos.stock.doctype.stock_entry.stock_entry import move_sample_to_retention_warehouse
	...
	def test_validation_as_per_bom_with_continuous_raw_material_consumption(self):
		from mes_euidos.manufacturing.doctype.production_plan.test_production_plan import make_bom
		from mes_euidos.manufacturing.doctype.work_order.work_order import make_stock_entry as _make_stock_entry
		from mes_euidos.manufacturing.doctype.work_order.work_order import make_work_order
	...
	def test_qi_creation_with_naming_rule_company_condition(self):
		...
		"""
		from mes_euidos.controllers.stock_controller import make_quality_inspections
		from mes_euidos.stock.doctype.warehouse.test_warehouse import create_warehouse
...
def initialize_records_for_future_negative_sle_test(
	...
	from mes_euidos.stock.doctype.batch.test_batch import TestBatch, make_new_batch
	from mes_euidos.stock.doctype.stock_reconciliation.test_stock_reconciliation import (
		create_stock_reconciliation,
	)
	from mes_euidos.stock.doctype.warehouse.test_warehouse import create_warehouse

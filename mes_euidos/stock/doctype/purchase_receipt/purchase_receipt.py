...
from mes_euidos.controllers.accounts_controller import merge_taxes
from mes_euidos.controllers.buying_controller import BuyingController
from mes_euidos.stock.doctype.delivery_note.delivery_note import make_inter_company_transaction
...
class PurchaseReceipt(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from mes_euidos.stock.doctype.purchase_receipt_item.purchase_receipt_item import PurchaseReceiptItem
	...
	def make_item_gl_entries(self, gl_entries, inventory_account_map=None):
		...
		for d in self.get("items"):
			...
			if (
				...
				if not (
					(mes_euidos.is_perpetual_inventory_enabled(self.company) and d.item_code in stock_items)
...
def make_purchase_invoice(source_name, target_doc=None, args=None):
	...
	from mes_euidos.accounts.party import get_payment_terms_template

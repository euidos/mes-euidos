...
import mes_euidos
import mes_euidos.controllers
import mes_euidos.controllers.status_updater
from mes_euidos.accounts.doctype.account.test_account import get_inventory_account
from mes_euidos.buying.doctype.supplier.test_supplier import create_supplier
from mes_euidos.controllers.accounts_controller import InvalidQtyError
from mes_euidos.controllers.buying_controller import QtyMismatchError
from mes_euidos.stock import get_warehouse_account_map
from mes_euidos.stock.doctype.item.test_item import create_item, make_item
from mes_euidos.stock.doctype.material_request.material_request import make_purchase_order
from mes_euidos.stock.doctype.purchase_receipt.purchase_receipt import make_purchase_invoice
from mes_euidos.stock.doctype.serial_and_batch_bundle.serial_and_batch_bundle import (
...
from mes_euidos.stock.doctype.warehouse.test_warehouse import create_warehouse
...
class TestPurchaseReceipt(ERPNextTestSuite):
	...
	def test_make_purchase_invoice(self):
		from mes_euidos.accounts.doctype.payment_entry.test_payment_entry import create_payment_term
	...
	def test_purchase_receipt_no_gl_entry(self):
		from mes_euidos.stock.doctype.stock_entry.test_stock_entry import make_stock_entry
	...
	def test_purchase_receipt_gl_entry(self):
		...
		self.assertEqual(cint(mes_euidos.is_perpetual_inventory_enabled(pr.company)), 1)
	...
	def test_purchase_return_for_rejected_qty(self):
		from mes_euidos.stock.doctype.warehouse.test_warehouse import get_warehouse
	...
	def test_closed_purchase_receipt(self):
		from mes_euidos.stock.doctype.purchase_receipt.purchase_receipt import (
	...
	def test_pr_billing_status(self):
		...
		3. PO -> PR2.
		"""
		from mes_euidos.buying.doctype.purchase_order.purchase_order import (
			make_purchase_invoice as make_purchase_invoice_from_po,
		)
		from mes_euidos.buying.doctype.purchase_order.purchase_order import make_purchase_receipt
		from mes_euidos.buying.doctype.purchase_order.test_purchase_order import create_purchase_order
	...
	def test_purchase_return_with_submitted_asset(self):
		from mes_euidos.stock.doctype.purchase_receipt.purchase_receipt import make_purchase_return
	...
	def test_make_purchase_invoice_from_pr_for_returned_qty(self):
		from mes_euidos.buying.doctype.purchase_order.test_purchase_order import (
	...
	def test_stock_transfer_from_purchase_receipt(self):
		from mes_euidos.stock.doctype.delivery_note.delivery_note import make_inter_company_purchase_receipt
		from mes_euidos.stock.doctype.delivery_note.test_delivery_note import create_delivery_note
	...
	def test_lcv_for_internal_transfer(self):
		from mes_euidos.stock.doctype.delivery_note.delivery_note import make_inter_company_purchase_receipt
		from mes_euidos.stock.doctype.delivery_note.test_delivery_note import create_delivery_note
		from mes_euidos.stock.doctype.landed_cost_voucher.test_landed_cost_voucher import (
	...
	def test_stock_transfer_from_purchase_receipt_with_valuation(self):
		...
		from mes_euidos.stock.get_item_details import get_valuation_rate
		from mes_euidos.stock.utils import get_stock_balance
	...
	def test_po_to_pi_and_po_to_pr_worflow_full(self):
		...
		"""
		from mes_euidos.buying.doctype.purchase_order import purchase_order, test_purchase_order
	...
	def test_purchase_receipt_with_exchange_rate_difference(self):
		from mes_euidos.accounts.doctype.purchase_invoice.purchase_invoice import (
		...
		from mes_euidos.accounts.party import add_party_account
	...
	def test_payment_terms_are_fetched_when_creating_purchase_invoice(self):
		from mes_euidos.accounts.doctype.payment_entry.test_payment_entry import (
			create_payment_terms_template,
		)
		from mes_euidos.accounts.doctype.purchase_invoice.test_purchase_invoice import make_purchase_invoice
		from mes_euidos.buying.doctype.purchase_order.test_purchase_order import (
			create_purchase_order,
			make_pr_against_po,
		)
		from mes_euidos.selling.doctype.sales_order.test_sales_order import (
	...
	def test_neg_to_positive(self):
		from mes_euidos.stock.doctype.stock_entry.stock_entry_utils import make_stock_entry
	...
	def test_internal_transfer_pr_incoming_sle_anchored_to_dn_rate(self):
		...
		from mes_euidos.stock.doctype.delivery_note.delivery_note import make_inter_company_purchase_receipt
		from mes_euidos.stock.doctype.delivery_note.test_delivery_note import create_delivery_note
		from mes_euidos.stock.stock_ledger import update_entries_after
	...
	def test_backdated_transaction_for_internal_transfer_in_trasit_warehouse_for_purchase_invoice(
		...
		from mes_euidos.accounts.doctype.sales_invoice.sales_invoice import (
	...
	def test_disable_last_purchase_rate(self):
		from mes_euidos.stock.get_item_details import ItemDetailsCtx, get_item_details
	...
	def test_use_serial_batch_fields_for_serial_nos(self):
		from mes_euidos.stock.doctype.delivery_note.test_delivery_note import create_delivery_note
		from mes_euidos.stock.doctype.serial_no.serial_no import get_serial_nos
		from mes_euidos.stock.doctype.stock_reconciliation.test_stock_reconciliation import (
			create_stock_reconciliation,
		)
	...
	def test_pr_billed_amount_against_return_entry(self):
		from mes_euidos.accounts.doctype.purchase_invoice.purchase_invoice import make_debit_note
		from mes_euidos.stock.doctype.purchase_receipt.purchase_receipt import (
	...
	def test_valuation_taxes_lcv_repost_after_billing(self):
		...
		old_perpetual_inventory = mes_euidos.is_perpetual_inventory_enabled("_Test Company")
	...
	def test_sles_with_same_posting_datetime_and_creation(self):
		from mes_euidos.stock.doctype.stock_entry.test_stock_entry import make_stock_entry
		from mes_euidos.stock.report.stock_balance.stock_balance import execute
	...
	def test_internal_pr_qty_change_only_single_batch(self):
		...
		self.assertRaises(mes_euidos.controllers.status_updater.OverAllowanceError, pr.submit)
	...
	def test_multiple_transactions_with_same_posting_datetime(self):
		from mes_euidos.stock.doctype.delivery_note.test_delivery_note import create_delivery_note
		from mes_euidos.stock.stock_ledger import NegativeStockError
	...
	def test_purchase_receipt_gl_entries_for_asset_item(self):
		from mes_euidos.assets.doctype.asset.test_asset import create_fixed_asset_item
...
def prepare_data_for_internal_transfer():
	from mes_euidos.accounts.doctype.sales_invoice.test_sales_invoice import create_internal_supplier

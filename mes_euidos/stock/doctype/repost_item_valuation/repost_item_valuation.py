...
import mes_euidos
from mes_euidos.accounts.general_ledger import validate_accounting_period
from mes_euidos.accounts.utils import get_future_stock_vouchers, repost_gle_for_stock_vouchers
from mes_euidos.stock.stock_ledger import (
...
def repost_gl_entries(doc):
	if not cint(mes_euidos.is_perpetual_inventory_enabled(doc.company)):
		return
...
def execute_repost_item_valuation():
	...
	method = "mes_euidos.stock.doctype.repost_item_valuation.repost_item_valuation.repost_entries"
	if frappe.db.get_single_value("Stock Reposting Settings", "enable_parallel_reposting"):
		method = "mes_euidos.stock.doctype.repost_item_valuation.repost_item_valuation.run_parallel_reposting"

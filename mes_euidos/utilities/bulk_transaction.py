...
def task(doc_name, from_doctype, to_doctype):
	from mes_euidos.accounts.doctype.payment_entry import payment_entry
	from mes_euidos.accounts.doctype.purchase_invoice import purchase_invoice
	from mes_euidos.accounts.doctype.sales_invoice import sales_invoice
	from mes_euidos.buying.doctype.purchase_order import purchase_order
	from mes_euidos.buying.doctype.supplier_quotation import supplier_quotation
	from mes_euidos.selling.doctype.quotation import quotation
	from mes_euidos.selling.doctype.sales_order import sales_order
	from mes_euidos.stock.doctype.delivery_note import delivery_note
	from mes_euidos.stock.doctype.purchase_receipt import purchase_receipt

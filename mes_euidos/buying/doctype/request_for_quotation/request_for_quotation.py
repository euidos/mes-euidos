...
from mes_euidos.accounts.party import _get_party_details, get_party_account_currency
...
from mes_euidos.stock.doctype.material_request.material_request import set_missing_values
...
class RequestforQuotation(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from mes_euidos.buying.doctype.request_for_quotation_item.request_for_quotation_item import (
			RequestforQuotationItem,
		)
		from mes_euidos.buying.doctype.request_for_quotation_supplier.request_for_quotation_supplier import (

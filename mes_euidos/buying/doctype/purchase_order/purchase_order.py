...
from mes_euidos.accounts.party import get_party_account, get_party_account_currency
from mes_euidos.buying.utils import validate_for_items
...
from mes_euidos.stock.doctype.item.item import get_item_defaults, get_last_purchase_details
from mes_euidos.stock.stock_balance import get_ordered_qty, update_bin_qty
from mes_euidos.stock.utils import get_bin
from mes_euidos.subcontracting.doctype.subcontracting_bom.subcontracting_bom import (
...
class PurchaseOrder(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from mes_euidos.buying.doctype.purchase_order_item.purchase_order_item import PurchaseOrderItem
		from mes_euidos.buying.doctype.purchase_order_item_supplied.purchase_order_item_supplied import (

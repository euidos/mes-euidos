...
from mes_euidos.crm.utils import (
	CRMNote,
	copy_comments,
	link_communications,
	link_open_events,
...
class Opportunity(TransactionBase, CRMNote):
	...
	if TYPE_CHECKING:
		...
		from mes_euidos.crm.doctype.crm_note.crm_note import CRMNote
		from mes_euidos.crm.doctype.opportunity_item.opportunity_item import OpportunityItem
		from mes_euidos.crm.doctype.opportunity_lost_reason_detail.opportunity_lost_reason_detail import (
...
def make_quotation(source_name, target_doc=None):
	def set_missing_values(source, target):
		from mes_euidos.controllers.accounts_controller import get_default_taxes_and_charges
...
def make_opportunity_from_communication(
	...
	from mes_euidos.crm.doctype.lead.lead import make_lead_from_communication

...
from mes_euidos.crm.doctype.appointment.appointment import (
	Appointment,
	_check_agent_availability,
	handle_expired_unverified_appointments,
)
from mes_euidos.setup.doctype.holiday_list.test_holiday_list import make_holiday_list
from mes_euidos.tests.utils import ERPNextTestSuite
from mes_euidos.www.book_appointment.index import create_appointment, get_appointment_slots
from mes_euidos.www.book_appointment.verify import index as verify_index

...
from mes_euidos.accounts.party import set_taxes
from mes_euidos.controllers.selling_controller import SellingController
from mes_euidos.crm.utils import CRMNote, copy_comments, link_communications, link_open_events
from mes_euidos.selling.doctype.customer.customer import parse_full_name
...
def get_lead_details(lead, posting_date=None, company=None, doctype=None):
	...
	from mes_euidos.accounts.party import set_address_details

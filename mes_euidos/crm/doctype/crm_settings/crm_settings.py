...
from mes_euidos.crm.frappe_crm_api import is_crm_installed
...
class CRMSettings(Document):
	...
	if TYPE_CHECKING:
		...
		from mes_euidos.crm.doctype.frappe_crm_allowed_user.frappe_crm_allowed_user import FrappeCRMAllowedUser

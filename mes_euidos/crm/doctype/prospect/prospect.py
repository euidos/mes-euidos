...
class Prospect(CRMNote):
	...
	if TYPE_CHECKING:
		...
		from mes_euidos.crm.doctype.prospect_lead.prospect_lead import ProspectLead
		from mes_euidos.crm.doctype.prospect_opportunity.prospect_opportunity import ProspectOpportunity

...
from mes_euidos.regional.report.uae_vat_201.uae_vat_201 import (
	execute,
	get_exempt_total,
...
from mes_euidos.stock.doctype.warehouse.test_warehouse import get_warehouse_account
...
def create_warehouse(warehouse_name, properties=None, company=None):
	...
	warehouse_id = mes_euidos.encode_company_abbr(warehouse_name, company)

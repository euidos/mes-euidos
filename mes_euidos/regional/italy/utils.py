...
from mes_euidos.controllers.taxes_and_totals import get_itemised_tax
from mes_euidos.regional.italy import state_codes
...
def prepare_and_attach_invoice(doc, replace=False):
	...
	invoice_xml = frappe.render_template(
		"mes_euidos/regional/italy/e-invoice.xml",

...
from mes_euidos.assets.doctype.asset.asset import (
	make_sales_invoice,
	split_asset,
...
class TestDepreciationBasics(AssetSetup):
	...
	def test_depr_schedule_link_matches_at_currency_precision(self):
		...
		from mes_euidos.accounts.doctype.journal_entry import journal_entry as journal_entry_module
	...
	def test_split_asset_created_via_capitalization(self):
		...
		from mes_euidos.assets.doctype.asset_capitalization.test_asset_capitalization import (

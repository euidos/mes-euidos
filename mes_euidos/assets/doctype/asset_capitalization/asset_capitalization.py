...
import mes_euidos
from mes_euidos.assets.doctype.asset.asset import get_asset_value_after_depreciation
...
from mes_euidos.stock.utils import get_incoming_rate
...
class AssetCapitalization(StockController):
	...
	if TYPE_CHECKING:
		...
		from mes_euidos.assets.doctype.asset_capitalization_asset_item.asset_capitalization_asset_item import (
			AssetCapitalizationAssetItem,
		)
		from mes_euidos.assets.doctype.asset_capitalization_service_item.asset_capitalization_service_item import (
			AssetCapitalizationServiceItem,
		)
		from mes_euidos.assets.doctype.asset_capitalization_stock_item.asset_capitalization_stock_item import (

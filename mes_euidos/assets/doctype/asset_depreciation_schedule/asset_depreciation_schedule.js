...
frappe.ui.form.on("Depreciation Schedule", {
	make_depreciation_entry: function (frm, cdt, cdn) {
		...
		if (!row.journal_entry) {
			frappe.call({
				method: "mes_euidos.assets.doctype.asset.depreciation.make_depreciation_entry",
				args: {
	...
	depreciation_amount: function (frm, cdt, cdn) {
		mes_euidos.asset.set_accumulated_depreciation(frm);
	},
});

mes_euidos.asset.set_accumulated_depreciation = function (frm) {

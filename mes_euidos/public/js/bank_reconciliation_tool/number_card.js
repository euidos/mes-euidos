...
mes_euidos.accounts.bank_reconciliation.NumberCardManager = class NumberCardManager {
	constructor(opts) {
	...
	make_cards() {
		...
		chart_data.forEach((summary) => {
			let number_card = new mes_euidos.accounts.NumberCard(summary);
...
mes_euidos.accounts.NumberCard = class NumberCard {
	constructor(options) {

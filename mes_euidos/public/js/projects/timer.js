frappe.provide("mes_euidos.timesheet");

mes_euidos.timesheet.timer = function (frm, row, timestamp = 0) {
	...
	mes_euidos.timesheet.control_timer(frm, dialog, row, timestamp);
	dialog.show();
};

mes_euidos.timesheet.control_timer = function (frm, dialog, row, timestamp = 0) {

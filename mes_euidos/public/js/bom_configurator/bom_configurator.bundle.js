class BOMConfigurator {
	...
	tree_options() {
		return {
			...
			get_tree_nodes: "mes_euidos.manufacturing.doctype.bom_creator.bom_creator.get_children",
				...
				...[
					{ fieldtype: "Section Break" },
					{
						...
						get_query() {
							...
							if (doc.routing) {
								return {
									query: "mes_euidos.manufacturing.doctype.routing.routing.get_operations",
									filters: {
										routing: doc.routing,
									},
								};

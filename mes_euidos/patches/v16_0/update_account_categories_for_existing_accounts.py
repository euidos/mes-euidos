...
from mes_euidos.accounts.doctype.account.chart_of_accounts.chart_of_accounts import get_chart_metadata_fields
from mes_euidos.accounts.doctype.account.chart_of_accounts.verified import standard_chart_of_accounts

...
from mes_euidos.projects.doctype.project_template.test_project_template import make_project_template
from mes_euidos.projects.doctype.task.test_task import create_task
from mes_euidos.selling.doctype.sales_order.sales_order import make_project as make_project_from_so
...
class TestProject(ERPNextTestSuite):
	def test_project_total_costing_and_billing_amount(self):
		from mes_euidos.projects.doctype.timesheet.test_timesheet import make_timesheet

...
from mes_euidos.controllers.queries import get_filters_cond
from mes_euidos.controllers.website_list_for_contact import get_customers_suppliers
from mes_euidos.setup.doctype.holiday_list.holiday_list import is_holiday
...
class Project(Document):
	...
	if TYPE_CHECKING:
		...
		from mes_euidos.projects.doctype.project_user.project_user import ProjectUser

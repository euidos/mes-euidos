...
from mes_euidos.projects.doctype.task.task import CircularReferenceError, ParentIsGroupError
...
class TestTask(ERPNextTestSuite):
	...
	def test_overdue(self):
		...
		from mes_euidos.projects.doctype.task.task import set_tasks_as_overdue

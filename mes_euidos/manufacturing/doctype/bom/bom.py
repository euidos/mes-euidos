...
from mes_euidos.stock.doctype.item.item import get_item_details
from mes_euidos.stock.get_item_details import ItemDetailsCtx, get_conversion_factor, get_price_list_rate
...
class BOM(WebsiteGenerator):
	...
	if TYPE_CHECKING:
		...
		from mes_euidos.manufacturing.doctype.bom_explosion_item.bom_explosion_item import BOMExplosionItem
		from mes_euidos.manufacturing.doctype.bom_item.bom_item import BOMItem
		from mes_euidos.manufacturing.doctype.bom_operation.bom_operation import BOMOperation
		from mes_euidos.manufacturing.doctype.bom_secondary_item.bom_secondary_item import BOMSecondaryItem
	...
	def company_currency(self):
		return mes_euidos.get_company_currency(self.company)
...
def add_operating_cost_component_wise(stock_entry, work_order=None, op_expense_account=None, job_card=None):
	...
	from mes_euidos.stock.doctype.stock_entry.stock_entry import get_consumed_operating_cost
...
def add_operations_cost(stock_entry, work_order=None, expense_account=None, job_card=None):
	from mes_euidos.stock.doctype.stock_entry.stock_entry import (
...
def make_variant_bom(source_name, bom_no, item, variant_items, target_doc=None):
	from mes_euidos.manufacturing.doctype.work_order.work_order import add_variant_item

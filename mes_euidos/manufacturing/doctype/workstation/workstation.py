...
from mes_euidos.support.doctype.issue.issue import get_holidays
...
class Workstation(Document):
	...
	if TYPE_CHECKING:
		...
		from mes_euidos.manufacturing.doctype.workstation_cost.workstation_cost import WorkstationCost
		from mes_euidos.manufacturing.doctype.workstation_working_hour.workstation_working_hour import (

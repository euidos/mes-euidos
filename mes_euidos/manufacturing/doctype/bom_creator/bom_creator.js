...
mes_euidos.bom.BomConfigurator = class BomConfigurator extends mes_euidos.TransactionController {
	conversion_rate(doc) {
...
extend_cscript(cur_frm.cscript, new mes_euidos.bom.BomConfigurator({ frm: cur_frm }));

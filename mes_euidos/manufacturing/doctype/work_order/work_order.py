...
from mes_euidos.manufacturing.doctype.manufacturing_settings.manufacturing_settings import (
	get_mins_between_operations,
)
from mes_euidos.stock.doctype.batch.batch import make_batch
from mes_euidos.stock.doctype.item.item import get_item_defaults, validate_end_of_life
from mes_euidos.stock.doctype.serial_no.serial_no import get_available_serial_nos, get_serial_nos
from mes_euidos.stock.doctype.stock_reservation_entry.stock_reservation_entry import StockReservation
from mes_euidos.stock.stock_balance import get_planned_qty, update_bin_qty
from mes_euidos.stock.utils import get_bin, get_latest_stock_qty, validate_warehouse_company
...
class WorkOrder(Document):
	...
	if TYPE_CHECKING:
		...
		from mes_euidos.manufacturing.doctype.work_order_additional_item.work_order_additional_item import (
			WorkOrderAdditionalItem,
		)
		from mes_euidos.manufacturing.doctype.work_order_item.work_order_item import WorkOrderItem
		from mes_euidos.manufacturing.doctype.work_order_operation.work_order_operation import WorkOrderOperation
	...
	def update_work_order_qty(self):
		...
		for purpose, fieldname in (
			...
			from mes_euidos.selling.doctype.sales_order.sales_order import update_produced_qty_in_so_item
...
def make_work_order(
	...
	from mes_euidos import get_default_company
...
def make_stock_return_entry(work_order):
	from mes_euidos.stock.doctype.stock_entry.stock_entry import get_available_materials

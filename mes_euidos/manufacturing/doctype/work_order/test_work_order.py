...
from mes_euidos.manufacturing.doctype.job_card.job_card import JobCardCancelError
from mes_euidos.manufacturing.doctype.job_card.job_card import make_stock_entry as make_stock_entry_from_jc
...
from mes_euidos.stock.doctype.stock_entry import test_stock_entry
from mes_euidos.stock.doctype.warehouse.test_warehouse import create_warehouse
from mes_euidos.stock.utils import get_bin
...
class TestWorkOrder(ERPNextTestSuite):
	...
	def test_wo_completion_with_pl_bom(self):
		from mes_euidos.manufacturing.doctype.bom.test_bom import (
	...
	def test_status_in_process_when_only_one_required_item_transferred_via_pick_list(self):
		...
		from mes_euidos.manufacturing.doctype.work_order.work_order import create_pick_list
		from mes_euidos.stock.doctype.pick_list.pick_list import create_stock_entry
	...
	def test_disassembly_batch_tracked_items(self):
		from mes_euidos.stock.doctype.batch.batch import make_batch
		from mes_euidos.stock.doctype.stock_entry.test_stock_entry import (
			make_stock_entry as make_stock_entry_test_record,
		)
	...
	def test_stock_reservation_for_serialized_raw_material(self):
		from mes_euidos.stock.doctype.stock_entry.stock_entry_utils import (
			make_stock_entry as make_stock_entry_test_record,
		)
	...
	def test_send_to_subcontractor_can_consume_work_order_reserved_stock(self):
		...
		from mes_euidos.manufacturing.doctype.job_card.job_card import make_subcontracting_po
		from mes_euidos.stock.doctype.stock_entry.stock_entry_utils import (
			make_stock_entry as make_stock_entry_test_record,
		)
		from mes_euidos.stock.doctype.warehouse.test_warehouse import create_warehouse
	...
	def test_operations_time_planning_calculation(self):
		from mes_euidos.manufacturing.doctype.routing.test_routing import create_routing, setup_operations
	...
	def test_phantom_bom_explosion(self):
		from mes_euidos.manufacturing.doctype.bom.test_bom import create_tree_for_phantom_bom_tests
...
def prepare_data_for_workstation_type_check():
	from mes_euidos.manufacturing.doctype.operation.test_operation import make_operation
	from mes_euidos.manufacturing.doctype.workstation.test_workstation import make_workstation
	from mes_euidos.manufacturing.doctype.workstation_type.test_workstation_type import (

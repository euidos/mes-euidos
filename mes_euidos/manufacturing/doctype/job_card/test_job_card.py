...
from mes_euidos.manufacturing.doctype.job_card.job_card import (
...
from mes_euidos.manufacturing.doctype.work_order.work_order import WorkOrder, make_work_order
...
class TestJobCard(ERPNextTestSuite):
	...
	def test_if_corrective_jc_ops_cost_is_added_to_manufacture_stock_entry(self):
		...
		from mes_euidos.manufacturing.doctype.work_order.work_order import make_job_card
	...
	def test_job_card_material_request_and_bom_details(self):
		from mes_euidos.stock.doctype.material_request.material_request import make_stock_entry
	...
	def test_job_card_material_transfer_via_pick_list(self):
		from mes_euidos.stock.doctype.material_request.material_request import create_pick_list
	...
	def test_job_card_proccess_qty_and_completed_qty(self):
		from mes_euidos.manufacturing.doctype.routing.test_routing import (
			create_routing,
			setup_bom,
			setup_operations,
		)
	...
	def test_semi_fg_batch_auto_pull_on_manufacture(self):
		from mes_euidos.manufacturing.doctype.operation.test_operation import make_operation
		from mes_euidos.stock.doctype.item.test_item import make_item
		from mes_euidos.stock.serial_batch_bundle import get_batches_from_bundle
	...
	def test_semi_fg_auto_pull_with_uom_conversion(self):
		from mes_euidos.manufacturing.doctype.operation.test_operation import make_operation
		from mes_euidos.stock.doctype.item.test_item import make_item
		from mes_euidos.stock.doctype.stock_entry.stock_entry import set_previous_operation_serial_batch
		from mes_euidos.stock.serial_batch_bundle import get_batches_from_bundle

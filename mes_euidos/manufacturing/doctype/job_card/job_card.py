...
from mes_euidos.controllers.stock_controller import (
	QualityInspectionNotSubmittedError,
	QualityInspectionRejectedError,
)
from mes_euidos.manufacturing.doctype.bom.bom import add_additional_cost, get_bom_items_as_dict
from mes_euidos.manufacturing.doctype.manufacturing_settings.manufacturing_settings import (
	get_mins_between_operations,
)
from mes_euidos.manufacturing.doctype.workstation_type.workstation_type import get_workstations
...
class JobCard(Document):
	...
	if TYPE_CHECKING:
		...
		from mes_euidos.manufacturing.doctype.job_card_item.job_card_item import JobCardItem
		from mes_euidos.manufacturing.doctype.job_card_operation.job_card_operation import JobCardOperation
		from mes_euidos.manufacturing.doctype.job_card_scheduled_time.job_card_scheduled_time import (
			JobCardScheduledTime,
		)
		from mes_euidos.manufacturing.doctype.job_card_secondary_item.job_card_secondary_item import (
			JobCardSecondaryItem,
		)
		from mes_euidos.manufacturing.doctype.job_card_time_log.job_card_time_log import JobCardTimeLog
	...
	def make_stock_entry_for_semi_fg_item(self, auto_submit: bool = False):
		...
		from mes_euidos.stock.doctype.stock_entry_type.stock_entry_type import ManufactureEntry

...
from mes_euidos.accounts.report.sales_register.sales_register import execute
from mes_euidos.accounts.test.accounts_mixin import AccountsTestMixin
from mes_euidos.selling.doctype.customer.test_customer import make_customer

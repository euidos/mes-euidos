...
from mes_euidos.accounts.report.accounts_receivable.accounts_receivable import execute
...
class TestAccountsReceivable(ERPNextTestSuite, AccountsTestMixin):
	...
	def test_payment_terms_template_filters(self):
		from mes_euidos.controllers.accounts_controller import get_payment_terms

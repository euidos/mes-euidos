...
from mes_euidos.accounts.doctype.sales_invoice.sales_invoice import make_delivery_note, make_sales_return
from mes_euidos.accounts.doctype.sales_invoice.test_sales_invoice import create_sales_invoice
from mes_euidos.accounts.report.gross_profit.gross_profit import execute
...
class TestGrossProfit(ERPNextTestSuite):
	...
	def test_drop_ship(self):
		...
		from mes_euidos.selling.doctype.sales_order.sales_order import make_purchase_order, make_sales_invoice
		from mes_euidos.selling.doctype.sales_order.test_sales_order import make_sales_order

...
from mes_euidos.exceptions import InvalidAccountCurrency, PartyDisabled, PartyFrozen
...
def complete_contact_details(party_details):
	...
	if party_details.party_type == "Employee":
		from mes_euidos.setup.doctype.employee.employee import _get_contact_details as get_employee_contact
...
def set_taxes(
	...
	from mes_euidos.accounts.doctype.tax_rule.tax_rule import get_party_details, get_tax_template

...
from mes_euidos.accounts.doctype.accounting_dimension_filter.accounting_dimension_filter import (
	get_dimension_filter_map,
)
from mes_euidos.accounts.doctype.accounting_period.accounting_period import ClosedAccountingPeriod
from mes_euidos.accounts.doctype.budget.budget import validate_expense_against_budget
from mes_euidos.accounts.utils import create_payment_ledger_entry, is_immutable_ledger_enabled
from mes_euidos.controllers.budget_controller import BudgetValidation
from mes_euidos.exceptions import InvalidAccountDimensionError, MandatoryAccountDimensionError
...
def merge_similar_entries(gl_map, precision=None):
	...
	company = gl_map[0].company if gl_map else mes_euidos.get_default_company()
	...
	if frappe.db.exists("Period Closing Voucher", {"docstatus": 1, "company": company}):
		frappe.throw(
			_(
				...
				'<a href="https://docs.frappe.io/mes_euidos/period-closing-voucher#14-pcv-and-opening-entries" target="_blank" rel="noopener">'
				+ _("Read the docs")
				+ "</a>"
			),

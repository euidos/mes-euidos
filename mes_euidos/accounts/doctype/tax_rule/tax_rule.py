...
from mes_euidos.setup.doctype.customer_group.customer_group import get_parent_customer_groups
from mes_euidos.setup.doctype.supplier_group.supplier_group import get_parent_supplier_groups

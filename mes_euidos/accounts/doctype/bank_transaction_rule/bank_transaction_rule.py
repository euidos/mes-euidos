...
from mes_euidos.accounts.doctype.bank_transaction.bank_transaction import BankTransaction
...
class BankTransactionRule(Document):
	...
	if TYPE_CHECKING:
		...
		from mes_euidos.accounts.doctype.bank_transaction_rule_accounts.bank_transaction_rule_accounts import (
			BankTransactionRuleAccounts,
		)
		from mes_euidos.accounts.doctype.bank_transaction_rule_description_conditions.bank_transaction_rule_description_conditions import (

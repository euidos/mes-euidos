...
from mes_euidos.accounts.doctype.tax_withholding_entry.tax_withholding_entry import PurchaseTaxWithholding
from mes_euidos.accounts.general_ledger import (
	get_round_off_account_and_cost_center,
	make_gl_entries,
	make_reverse_gl_entries,
	merge_similar_entries,
)
from mes_euidos.accounts.party import get_due_date, get_party_account
...
from mes_euidos.assets.doctype.asset.asset import is_cwip_accounting_enabled
from mes_euidos.assets.doctype.asset_category.asset_category import get_asset_category_account
from mes_euidos.controllers.accounts_controller import merge_taxes, validate_account_head
from mes_euidos.controllers.buying_controller import BuyingController
...
class PurchaseInvoice(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from mes_euidos.accounts.doctype.purchase_invoice_advance.purchase_invoice_advance import (
			PurchaseInvoiceAdvance,
		)
		from mes_euidos.accounts.doctype.purchase_invoice_item.purchase_invoice_item import PurchaseInvoiceItem
		from mes_euidos.accounts.doctype.purchase_taxes_and_charges.purchase_taxes_and_charges import (
			PurchaseTaxesandCharges,
		)
		from mes_euidos.accounts.doctype.tax_withholding_entry.tax_withholding_entry import TaxWithholdingEntry
		from mes_euidos.buying.doctype.purchase_receipt_item_supplied.purchase_receipt_item_supplied import (
	...
	def get_gl_entries(self, inventory_account_map=None):
		self.auto_accounting_for_stock = mes_euidos.is_perpetual_inventory_enabled(self.company)
	...
	def update_billing_status_in_pr(self, update_modified=True):
		...
		for pr in set(updated_pr):
			from mes_euidos.stock.doctype.purchase_receipt.purchase_receipt import update_billing_percentage
...
def make_purchase_receipt(source_name, target_doc=None, args=None):
	...
	def update_item(obj, target, source_parent):
		from mes_euidos.controllers.sales_and_purchase_return import get_returned_qty_map_for_row

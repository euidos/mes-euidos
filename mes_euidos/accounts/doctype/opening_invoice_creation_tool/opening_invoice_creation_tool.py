...
from mes_euidos.stock.utils import get_default_stock_uom
...
class OpeningInvoiceCreationTool(Document):
	...
	if TYPE_CHECKING:
		...
		from mes_euidos.accounts.doctype.opening_invoice_creation_tool_item.opening_invoice_creation_tool_item import (

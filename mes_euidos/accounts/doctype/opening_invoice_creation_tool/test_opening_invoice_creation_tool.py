...
from mes_euidos.accounts.doctype.opening_invoice_creation_tool.opening_invoice_creation_tool import (
...
class TestOpeningInvoiceCreationTool(ERPNextTestSuite):
	...
	def test_opening_sales_invoice_creation_with_missing_debit_account(self):
		...
		error_log = frappe.db.exists(
			"Error Log",
			{"error": ["like", "%mes_euidos.controllers.accounts_controller.AccountMissingError%"]},
		)

...
import mes_euidos
from mes_euidos.accounts.doctype.accounting_dimension.accounting_dimension import get_dimensions
from mes_euidos.accounts.doctype.bank_account.bank_account import (
...
from mes_euidos.accounts.doctype.journal_entry.journal_entry import get_default_bank_cash_account
from mes_euidos.accounts.doctype.repost_accounting_ledger.repost_accounting_ledger import (
	validate_docs_for_deferred_accounting,
	validate_docs_for_voucher_types,
)
from mes_euidos.accounts.doctype.tax_withholding_entry.tax_withholding_entry import PaymentTaxWithholding
...
from mes_euidos.controllers.accounts_controller import (
	AccountsController,
...
class PaymentEntry(AccountsController):
	...
	if TYPE_CHECKING:
		...
		from mes_euidos.accounts.doctype.advance_taxes_and_charges.advance_taxes_and_charges import (
			AdvanceTaxesandCharges,
		)
		from mes_euidos.accounts.doctype.payment_entry_deduction.payment_entry_deduction import (
			PaymentEntryDeduction,
		)
		from mes_euidos.accounts.doctype.payment_entry_reference.payment_entry_reference import (
	...
	def update_payment_requests(self, cancel=False):
		from mes_euidos.accounts.doctype.payment_request.payment_request import (
...
def get_reference_details(
	...
	company_currency = ref_doc.get("company_currency") or mes_euidos.get_company_currency(ref_doc.company)

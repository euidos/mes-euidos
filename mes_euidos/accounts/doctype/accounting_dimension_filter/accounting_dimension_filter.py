...
class AccountingDimensionFilter(Document):
	...
	if TYPE_CHECKING:
		...
		from mes_euidos.accounts.doctype.allowed_dimension.allowed_dimension import AllowedDimension
		from mes_euidos.accounts.doctype.applicable_on_account.applicable_on_account import ApplicableOnAccount

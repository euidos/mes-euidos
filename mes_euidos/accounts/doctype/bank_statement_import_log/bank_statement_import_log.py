...
from mes_euidos.accounts.doctype.bank_account.bank_account import set_closing_balance_as_per_statement
...
class BankStatementImportLog(Document):
	...
	if TYPE_CHECKING:
		...
		from mes_euidos.accounts.doctype.bank_statement_import_log_column_map.bank_statement_import_log_column_map import (
	...
	def insert_transactions(self):
		...
		from mes_euidos.accounts.doctype.bank_transaction_rule.bank_transaction_rule import run_rule_evaluation

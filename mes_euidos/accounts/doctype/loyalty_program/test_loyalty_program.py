...
from mes_euidos.accounts.party import get_dashboard_info
...
class TestLoyaltyProgram(ERPNextTestSuite):
	...
	@unittest.mock.patch("mes_euidos.accounts.doctype.loyalty_program.loyalty_program.get_loyalty_details")

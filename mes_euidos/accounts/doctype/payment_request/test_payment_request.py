...
from mes_euidos.accounts.doctype.payment_entry.test_payment_entry import create_payment_terms_template
...
class TestPaymentRequest(ERPNextTestSuite):
	def setUp(self):
		...
		send_email = patch(
			"mes_euidos.accounts.doctype.payment_request.payment_request.PaymentRequest.send_email",
			return_value=None,
		)
		...
		_get_payment_gateway_controller = patch(
			"mes_euidos.accounts.doctype.payment_request.payment_request._get_payment_gateway_controller",
		)

...
from mes_euidos.accounts.doctype.bank_account.bank_account import get_party_bank_account
from mes_euidos.accounts.doctype.payment_entry.payment_entry import (
	get_payment_entry,
)
from mes_euidos.accounts.doctype.subscription_plan.subscription_plan import get_plan_rate
from mes_euidos.accounts.party import get_party_account
from mes_euidos.accounts.utils import get_account_currency, get_advance_payment_doctypes, get_currency_precision
from mes_euidos.utilities import payment_app_import_guard
...
class PaymentRequest(Document):
	...
	if TYPE_CHECKING:
		...
		from mes_euidos.accounts.doctype.payment_reference.payment_reference import PaymentReference
		from mes_euidos.accounts.doctype.subscription_plan_detail.subscription_plan_detail import (

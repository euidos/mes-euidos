...
from mes_euidos.accounts.doctype.pos_invoice.pos_invoice import make_sales_return
from mes_euidos.accounts.doctype.pos_profile.test_pos_profile import make_pos_profile
from mes_euidos.accounts.doctype.sales_invoice.sales_invoice import PartialPaymentValidationError
...
class POSInvoiceTestMixin(ERPNextTestSuite):
	def setUp(self):
		from mes_euidos.accounts.doctype.pos_closing_entry.test_pos_closing_entry import init_user_and_profile
...
class TestPOSInvoice(POSInvoiceTestMixin):
	def setUp(self):
		super().setUp()
		from mes_euidos.accounts.doctype.pos_opening_entry.test_pos_opening_entry import create_opening_entry
	...
	def test_ignore_pricing_rule(self):
		from mes_euidos.accounts.doctype.pricing_rule.test_pricing_rule import make_pricing_rule
	...
	def test_delivered_serial_no_case(self):
		from mes_euidos.accounts.doctype.pos_invoice_merge_log.test_pos_invoice_merge_log import (
	...
	def test_bundle_stock_availability_validation(self):
		from mes_euidos.accounts.doctype.pos_invoice.pos_invoice import ProductBundleStockValidationError
		from mes_euidos.accounts.doctype.pos_invoice_merge_log.test_pos_invoice_merge_log import (
			init_user_and_profile,
		)

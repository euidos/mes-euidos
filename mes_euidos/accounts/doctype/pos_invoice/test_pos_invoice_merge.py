...
from mes_euidos.accounts.doctype.pos_invoice.test_pos_invoice import POSInvoiceTestMixin, create_pos_invoice
...
class TestPOSInvoiceMerging(POSInvoiceTestMixin):
	...
	def test_merging_into_sales_invoice_with_discount(self):
		...
		from mes_euidos.accounts.doctype.pos_invoice_merge_log.pos_invoice_merge_log import (

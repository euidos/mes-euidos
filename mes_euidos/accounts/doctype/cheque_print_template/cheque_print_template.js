...
frappe.provide("mes_euidos.cheque_print");
		...
		if (!frm.doc.__islocal) {
			if (frappe.user.has_role("System Manager")) {
				frm.add_custom_button(
					...
					function () {
						mes_euidos.cheque_print.view_cheque_print(frm);
					}
...
mes_euidos.cheque_print.view_cheque_print = function (frm) {
	frappe.call({
		method: "mes_euidos.accounts.doctype.cheque_print_template.cheque_print_template.create_or_update_cheque_print_format",
		args: {

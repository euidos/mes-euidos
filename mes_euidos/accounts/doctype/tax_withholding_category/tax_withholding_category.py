...
from mes_euidos import allow_regional
...
class TaxWithholdingCategory(Document):
	...
	if TYPE_CHECKING:
		...
		from mes_euidos.accounts.doctype.tax_withholding_account.tax_withholding_account import (
			TaxWithholdingAccount,
		)
		from mes_euidos.accounts.doctype.tax_withholding_rate.tax_withholding_rate import TaxWithholdingRate

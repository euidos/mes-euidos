...
class TestTaxWithholdingCategory(ERPNextTestSuite):
	...
	def test_tax_withholding_entry_status_determination(self):
		...
		from mes_euidos.accounts.doctype.tax_withholding_entry.tax_withholding_entry import (
			TaxWithholdingEntry,
		)
	...
	def test_threshold_considers_two_parties_with_same_tax_id_with_overrided_hook(self):
		...
		with patch(
			"mes_euidos.accounts.doctype.tax_withholding_category.tax_withholding_category.get_tax_id_for_party",

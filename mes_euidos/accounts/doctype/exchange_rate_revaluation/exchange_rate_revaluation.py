...
import mes_euidos
from mes_euidos.accounts.doctype.journal_entry.journal_entry import get_balance_on
from mes_euidos.accounts.utils import get_currency_precision
...
class ExchangeRateRevaluation(Document):
	...
	if TYPE_CHECKING:
		...
		from mes_euidos.accounts.doctype.exchange_rate_revaluation_account.exchange_rate_revaluation_account import (
...
def get_account_details(
	...
	account_details = {}
	mes_euidos.get_company_currency(company)

...
from mes_euidos.accounts.utils import sync_auto_reconcile_config
...
class AccountsSettings(Document):
	...
	if TYPE_CHECKING:
		...
		from mes_euidos.accounts.doctype.repost_allowed_types.repost_allowed_types import RepostAllowedTypes
	...
	def update_property_for_accounting_dimension(self):
		...
		from mes_euidos.accounts.doctype.repost_accounting_ledger.repost_accounting_ledger import get_child_docs

...
import mes_euidos
from mes_euidos.accounts.doctype.account.test_account import create_account, get_inventory_account
from mes_euidos.accounts.doctype.mode_of_payment.test_mode_of_payment import (
	set_default_account_for_mode_of_payment,
)
from mes_euidos.accounts.doctype.pos_profile.test_pos_profile import make_pos_profile
from mes_euidos.accounts.doctype.purchase_invoice.purchase_invoice import WarehouseMissingError
from mes_euidos.accounts.doctype.purchase_invoice.test_purchase_invoice import (
	unlink_payment_on_cancel_of_invoice,
)
from mes_euidos.accounts.doctype.sales_invoice.sales_invoice import make_inter_company_transaction
from mes_euidos.accounts.utils import PaymentEntryUnlinkError
from mes_euidos.assets.doctype.asset.depreciation import post_depreciation_entries
from mes_euidos.assets.doctype.asset.test_asset import create_asset
from mes_euidos.assets.doctype.asset_depreciation_schedule.asset_depreciation_schedule import (
	get_depr_schedule,
)
from mes_euidos.controllers.accounts_controller import InvalidQtyError, update_invoice_status
from mes_euidos.controllers.taxes_and_totals import get_itemised_tax_breakup_data
from mes_euidos.exceptions import InvalidAccountCurrency, InvalidCurrency
from mes_euidos.selling.doctype.customer.test_customer import get_customer_dict
from mes_euidos.stock.doctype.delivery_note.delivery_note import make_sales_invoice
from mes_euidos.stock.doctype.item.test_item import create_item
from mes_euidos.stock.doctype.purchase_receipt.test_purchase_receipt import make_purchase_receipt
from mes_euidos.stock.doctype.serial_and_batch_bundle.test_serial_and_batch_bundle import (
	get_batch_from_bundle,
	get_serial_nos_from_bundle,
	make_serial_batch_bundle,
)
from mes_euidos.stock.doctype.stock_entry.test_stock_entry import (
	get_qty_after_transaction,
	make_stock_entry,
)
from mes_euidos.stock.doctype.stock_reconciliation.test_stock_reconciliation import (
	create_stock_reconciliation,
)
from mes_euidos.stock.get_item_details import get_item_tax_map
from mes_euidos.stock.utils import get_incoming_rate, get_stock_balance
...
class TestSalesInvoice(ERPNextTestSuite):
	def setUp(self):
		...
		from mes_euidos.stock.doctype.stock_ledger_entry.test_stock_ledger_entry import create_items
	...
	def test_invalid_rate_without_override(self):
		...
		from mes_euidos.accounts.doctype.sales_invoice.sales_invoice import make_inter_company_purchase_invoice
	...
	def test_payment_entry_unlink_against_invoice(self):
		from mes_euidos.accounts.doctype.payment_entry.test_payment_entry import get_payment_entry
	...
	def test_outstanding_on_cost_center_allocation(self):
		# setup cost centers
		from mes_euidos.accounts.doctype.cost_center.test_cost_center import create_cost_center
		from mes_euidos.accounts.doctype.cost_center_allocation.test_cost_center_allocation import (
	...
	def test_pos_returns_with_repayment(self):
		from mes_euidos.accounts.doctype.sales_invoice.sales_invoice import make_sales_return
	...
	def test_bin_details_of_packed_item(self):
		from mes_euidos.selling.doctype.product_bundle.test_product_bundle import make_product_bundle
		from mes_euidos.stock.doctype.item.test_item import make_item
	...
	def test_serialized(self):
		from mes_euidos.stock.doctype.stock_entry.test_stock_entry import make_serialized_item
	...
	def test_serial_numbers_against_delivery_note(self):
		...
		"""
		from mes_euidos.stock.doctype.delivery_note.test_delivery_note import create_delivery_note
		from mes_euidos.stock.doctype.stock_entry.test_stock_entry import make_serialized_item
	...
	def test_outstanding_amount_after_advance_payment_entry_cancellation(self):
		...
		from mes_euidos.selling.doctype.sales_order.test_sales_order import make_sales_order
	...
	def test_company_monthly_sales(self):
		from mes_euidos.setup.doctype.company.company import update_company_current_month_sales
	...
	def test_sales_invoice_with_shipping_rule(self):
		from mes_euidos.accounts.doctype.shipping_rule.test_shipping_rule import create_shipping_rule
	...
	def test_sales_invoice_with_project_link(self):
		from mes_euidos.projects.doctype.project.test_project import make_project
	...
	def test_inter_company_transaction_without_default_warehouse(self):
		...
		old_perpetual_inventory = mes_euidos.is_perpetual_inventory_enabled("_Test Company 1")
	...
	def test_additional_discount_for_sales_invoice_with_discount_accounting_enabled(self):
		from mes_euidos.accounts.doctype.repost_accounting_ledger.test_repost_accounting_ledger import (
	...
	def test_sales_invoice_against_supplier(self):
		from mes_euidos.accounts.doctype.opening_invoice_creation_tool.test_opening_invoice_creation_tool import (
			make_customer,
		)
		from mes_euidos.accounts.doctype.party_link.party_link import create_party_link
		from mes_euidos.buying.doctype.supplier.test_supplier import create_supplier
	...
	def test_sales_invoice_return_common_party_je_has_no_negative_amounts(self):
		...
		from mes_euidos.accounts.doctype.party_link.party_link import create_party_link
		from mes_euidos.buying.doctype.supplier.test_supplier import create_supplier
		from mes_euidos.controllers.sales_and_purchase_return import make_return_doc
	...
	def test_non_stock_item_over_billing_against_so_is_blocked(self):
		from mes_euidos.selling.doctype.sales_order.sales_order import make_sales_invoice as make_si_from_so
		from mes_euidos.selling.doctype.sales_order.test_sales_order import make_sales_order
	...
	def test_non_stock_item_over_billing_against_so_from_quotation_is_blocked(self):
		from mes_euidos.selling.doctype.quotation.quotation import make_sales_order as make_so_from_quotation
		from mes_euidos.selling.doctype.quotation.test_quotation import make_quotation
		from mes_euidos.selling.doctype.sales_order.sales_order import make_sales_invoice as make_si_from_so
	...
	def test_gain_loss_with_advance_entry(self):
		from mes_euidos.accounts.doctype.journal_entry.test_journal_entry import make_journal_entry
	...
	def test_advance_entries_as_liability(self):
		from mes_euidos.accounts.doctype.payment_entry.test_payment_entry import create_payment_entry
	...
	def test_loyalty_points_redemption_with_shopping_cart(self):
		from mes_euidos.accounts.doctype.loyalty_program.test_loyalty_program import (
			create_sales_invoice_record,
		)
		from mes_euidos.selling.doctype.sales_order.sales_order import make_sales_invoice
		from mes_euidos.selling.doctype.sales_order.test_sales_order import make_sales_order
	...
	def test_taxes_merging_from_delivery_note(self):
		...
		map_docs(
			method="mes_euidos.stock.doctype.delivery_note.delivery_note.make_sales_invoice",
	...
	def test_common_party_with_foreign_currency_jv(self):
		from mes_euidos.accounts.doctype.account.test_account import create_account
		from mes_euidos.accounts.doctype.opening_invoice_creation_tool.test_opening_invoice_creation_tool import (
			make_customer,
		)
		from mes_euidos.accounts.doctype.party_link.party_link import create_party_link
		from mes_euidos.buying.doctype.supplier.test_supplier import create_supplier
		from mes_euidos.setup.utils import get_exchange_rate
	...
	def test_create_return_invoice_for_self_update(self):
		from mes_euidos.accounts.doctype.payment_entry.payment_entry import get_payment_entry
		from mes_euidos.accounts.doctype.sales_invoice.test_sales_invoice import create_sales_invoice
		from mes_euidos.controllers.sales_and_purchase_return import make_return_doc
	...
	def test_prevents_fully_returned_invoice_with_zero_quantity(self):
		from mes_euidos.controllers.sales_and_purchase_return import StockOverReturnError, make_return_doc
...
def create_internal_parties():
	from mes_euidos.selling.doctype.customer.test_customer import create_internal_customer

...
class POSProfile(Document):
	...
	if TYPE_CHECKING:
		...
		from mes_euidos.accounts.doctype.pos_customer_group.pos_customer_group import POSCustomerGroup
		from mes_euidos.accounts.doctype.pos_item_group.pos_item_group import POSItemGroup
		from mes_euidos.accounts.doctype.pos_payment_method.pos_payment_method import POSPaymentMethod
		from mes_euidos.accounts.doctype.pos_profile_user.pos_profile_user import POSProfileUser

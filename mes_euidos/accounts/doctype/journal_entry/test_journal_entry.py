...
from mes_euidos.accounts.doctype.journal_entry.journal_entry import StockAccountInvalidTransaction
from mes_euidos.exceptions import InvalidAccountCurrency
from mes_euidos.selling.doctype.customer.test_customer import make_customer, set_credit_limit
...
class TestJournalEntry(ERPNextTestSuite):
	...
	def test_reverse_journal_entry(self):
		from mes_euidos.accounts.doctype.journal_entry.journal_entry import make_reverse_journal_entry

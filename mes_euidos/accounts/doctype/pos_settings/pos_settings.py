...
class POSSettings(Document):
	...
	if TYPE_CHECKING:
		...
		from mes_euidos.accounts.doctype.pos_field.pos_field import POSField
		from mes_euidos.accounts.doctype.pos_search_fields.pos_search_fields import POSSearchFields

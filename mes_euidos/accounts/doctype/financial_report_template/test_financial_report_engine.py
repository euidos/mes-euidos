...
from mes_euidos.accounts.doctype.financial_report_template.test_financial_report_template import (
...
from mes_euidos.accounts.utils import get_currency_precision, get_fiscal_year
from mes_euidos.tests.utils import change_settings

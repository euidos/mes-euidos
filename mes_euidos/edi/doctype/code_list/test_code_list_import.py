...
from mes_euidos.edi.doctype.code_list import code_list_import
...
class TestCodeListImport(ERPNextTestSuite):
	def test_import_genericode_rejects_remote_file_url(self):
		...
		with patch("mes_euidos.edi.doctype.code_list.code_list_import.requests.get") as mock_get:
	...
	def test_import_genericode_from_trusted_url(self):
		...
		with patch(
			"mes_euidos.edi.doctype.code_list.code_list_import.requests.get",

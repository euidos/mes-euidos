frappe.provide("mes_euidos.edi");

mes_euidos.edi.import_genericode = function (listview_or_form) {
	...
	new frappe.ui.FileUploader({
		method: "mes_euidos.edi.doctype.code_list.code_list_import.import_genericode",
		doctype: doctype,
		docname: docname,
...
function show_column_selection_dialog(context) {
	...
	let d = new frappe.ui.Dialog({
		...
		primary_action(values) {
			...
			frappe
				.xcall("mes_euidos.edi.doctype.code_list.code_list_import.process_genericode_import", {

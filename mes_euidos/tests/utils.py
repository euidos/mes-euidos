...
class BootStrapTestData:
	...
	def make_presets(self):
		...
		from mes_euidos.setup.setup_wizard.operations.install_fixtures import (
			add_uom_data,
			get_preset_records,
			get_sale_stages,
		)
		...
		from mes_euidos.setup.setup_wizard.operations.install_fixtures import read_lines
		...
		from mes_euidos.buying.doctype.supplier_scorecard.supplier_scorecard import (

...
import mes_euidos
from mes_euidos.accounts.utils import build_qb_match_conditions
from mes_euidos.stock.get_item_details import ItemDetailsCtx, _get_item_tax_template
...
def tax_account_query(doctype, txt, searchfield, start, page_len, filters):
	doctype = "Account"
	company_currency = mes_euidos.get_company_currency(filters.get("company"))

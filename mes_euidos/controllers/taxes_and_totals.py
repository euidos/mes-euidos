...
import mes_euidos
from mes_euidos.accounts.doctype.journal_entry.journal_entry import get_exchange_rate
from mes_euidos.accounts.doctype.pricing_rule.utils import get_applied_pricing_rules
...
class calculate_taxes_and_totals:
	...
	def validate_conversion_rate(self):
		...
		company_currency = mes_euidos.get_company_currency(self.doc.company)
...
from mes_euidos.deprecation_dumpster import (

...
from mes_euidos.accounts.party import render_address
from mes_euidos.controllers.accounts_controller import get_taxes_and_charges
from mes_euidos.controllers.sales_and_purchase_return import get_rate_for_return, is_batch_expired
from mes_euidos.controllers.stock_controller import StockController
from mes_euidos.stock.doctype.item.item import set_item_default
from mes_euidos.stock.get_item_details import get_bin_details, get_conversion_factor
from mes_euidos.stock.utils import get_combine_datetime, get_incoming_rate, get_valuation_method
...
class SellingController(StockController):
	...
	def set_missing_lead_customer_details(self, for_validate=False):
		...
		if customer:
			from mes_euidos.accounts.party import _get_party_details
			...
			from mes_euidos.crm.doctype.lead.lead import get_lead_details
	...
	def set_incoming_rate(self):
		...
		from mes_euidos.stock.serial_batch_bundle import get_batch_nos, get_serial_nos
	...
	def validate_items(self):
		...
		from mes_euidos.controllers.buying_controller import validate_item_type

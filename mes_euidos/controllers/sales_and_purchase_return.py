...
from mes_euidos.stock.utils import get_combine_datetime, get_incoming_rate, get_valuation_method, getdate
...
def validate_quantity(doc, key, args, ref, valid_items, already_returned_items):
	...
	company_currency = mes_euidos.get_company_currency(doc.company)

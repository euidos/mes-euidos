...
from mes_euidos.accounts.utils import cancel_exchange_gain_loss_journal, get_fiscal_year
from mes_euidos.controllers.accounts_controller import AccountsController
from mes_euidos.controllers.sales_and_purchase_return import (
	available_serial_batch_for_return,
	filter_serial_batches,
	make_serial_batch_bundle_for_return,
)

# Re-exported for backward compatibility; canonical home is mes_euidos.exceptions.
from mes_euidos.exceptions import (
	BatchExpiredError,
...
from mes_euidos.stock.doctype.inventory_dimension.inventory_dimension import (
...
from mes_euidos.stock.stock_ledger import get_items_to_be_repost
...
# Keep this in sync with mes_euidos.stock.qi_* helpers in transaction.js.
...
class StockController(AccountsController):
	...
	def make_gl_entries(self, gl_entries=None, from_repost=False, via_landed_cost_voucher=False):
		...
		need_inventory_map = (self.get_stock_items() or self.get("packed_items")) and (
			cint(mes_euidos.is_perpetual_inventory_enabled(self.company))
		)
	...
	def clean_serial_nos(self):
		from mes_euidos.stock.doctype.serial_no.serial_no import clean_serial_no_string
	...
	def get_sl_entries(self, d, args):
		...
		if self.docstatus == 2:
			from mes_euidos.deprecation_dumpster import deprecation_warning
	...
	def make_sl_entries(self, sl_entries, allow_negative_stock=False, via_landed_cost_voucher=False):
		from mes_euidos.stock.serial_batch_bundle import update_batch_qty
		from mes_euidos.stock.stock_ledger import make_sl_entries
	...
	def validate_warehouse(self):
		from mes_euidos.stock.utils import validate_disabled_warehouse, validate_warehouse_company
	...
	def validate_putaway_capacity(self):
		...
		from mes_euidos.stock.doctype.putaway_rule.putaway_rule import get_available_putaway_capacity
...
def get_accounting_ledger_preview(doc, filters):
	from mes_euidos.accounts.report.general_ledger.general_ledger import get_columns as get_gl_columns
...
def get_stock_ledger_preview(doc, filters):
	from mes_euidos.stock.report.stock_ledger.stock_ledger import get_columns as get_sl_columns
...
def future_sle_exists(args, sl_entries=None):
	from mes_euidos.stock.utils import get_combine_datetime

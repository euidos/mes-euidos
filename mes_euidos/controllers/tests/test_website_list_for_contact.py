...
class TestWebsiteListForContact(ERPNextTestSuite):
	...
	def test_rfq_transaction_list_returns_supplier_rfq(self):
		...
		from mes_euidos.buying.doctype.request_for_quotation.test_request_for_quotation import (
			make_request_for_quotation,
		)
		from mes_euidos.controllers.website_list_for_contact import rfq_transaction_list
